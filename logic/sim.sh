...
ghdl -a --std=08 cpu/bss2k.vhdl cpu/cpu_pipelined.vhdl cpu/cpu_sequential.vhdl cpu/registers.vhdl cpu/tb_cpu.vhdl cpu/tb_cpu_sim_pipe.vhdl cpu/tb_cpu_sim_seq.vhdl

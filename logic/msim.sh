...
vcom -2008 cpu/data_arbiter.vhdl cpu/tb_data_arbiter.vhdl
vsim -l tb_data_arbiter.log -t ps -c tb_data_arbiter -do "vcd file tb_data_arbiter.vcd" -do "vcd add -r *" -do "run -a" -do "quit"

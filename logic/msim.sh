...
rm -rf work
vlib work
vcom -2008 bss2k.vhdl cpu/altera_registers.vhd cpu/cpu_pipelined.vhdl cpu/cpu_sequential.vhdl cpu/tb_cpu.vhdl cpu/tb_cpu_altera_pipe.vhdl cpu/tb_cpu_altera_seq.vhdl
